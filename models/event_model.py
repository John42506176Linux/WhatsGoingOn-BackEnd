...
class Event(BaseModel):
    ...
    event_location: Optional[str] = Field(description="The location of the event in City, State format (e.g. San Francisco, CA)")
    event_photo_link: Optional[str] = Field(description="The photo link for the event")
